...
<template>
  <div class="table-responsive">
                ...
                <div class="card-body row">
                  ...
                  >
                    <div class="btn-group" role="group" aria-label="Basic example">
                      <button type="button" class="btn btn-primary" @click.prevent="asignar">Asignar de Nuevo</button>
    ...
    <div class="modal fade" :id="'editAsig' + index" aria-hidden="true" @hidde="recargar">
